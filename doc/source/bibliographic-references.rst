...
.. [Cal12] Sergio Callegari, Federico Bizzarri *"Should ΔΣ modulators
   ...
   <https://dx.doi.org/10.1109/ICECS.2012.6463619>`_, also available on
   `arXiv <https://arxiv.org/abs/1302.7172>`__
...
.. [Cal13a] Sergio Callegari, Federico Bizzarri *“Output Filter Aware
   ...
   <https://dx.doi.org/10.1109/TCSI.2013.2239091>`_. Pre-print
   available on `arXiv <https://arxiv.org/abs/1302.3020>`__.
...
.. [Cal13b] Sergio Callegari, Federico Bizzarri *“Noise Weighting in the
   ...
   <https://dx.doi.org/10.1109/TCSII.2013.2281892>`_. Pre-print
...
.. [Cal13c] Sergio Callegari, Federico Bizzarri, *"Should ΔΣ
    ...
    <https://dx.doi.org/10.1109/ICECS.2013.6815483>`_. Also available
    in `arXiv <https://arxiv.org/abs/1302.7172>`__.
