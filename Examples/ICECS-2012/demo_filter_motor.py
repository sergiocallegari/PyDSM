...
from pydsm.NTFdesign.filter_based import (synthesize_ntf_from_filter_ir,
...
ntf0043=synthesize_ntf_from_filter_ir(P, hz0043_ir)
ntf02=synthesize_ntf_from_filter_ir(P, hz02_ir)
ntf06=synthesize_ntf_from_filter_ir(P, hz06_ir)
