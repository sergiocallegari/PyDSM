...
"""Demo code to replicate the results shown in Figure 5 and in table 1,
of the paper:
...
This code is about the reference case, where two independent single band
low pass modulators are used.

Copyright (c) Sergio Callegari, 2013.
All rights reserved.
"""
